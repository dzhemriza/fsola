 ...
 * org.fsola
 *
 * File Name: PermutationSwapTest.java
 *
...
import org.fsola.introduction.PermutationSwap;
...
public class PermutationSwapTest {
    ...
    public void testPermutation1() {
        Integer[][] e =
                new Integer[][]{{1, 2, 3}, {2, 1, 3}, {3, 2, 1}, {2, 3, 1},
                        {1, 3, 2}, {3, 1, 2}};

        PermutationSwap perm = new PermutationSwap();
