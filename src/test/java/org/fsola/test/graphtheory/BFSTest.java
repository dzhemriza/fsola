...
import org.fsola.graphtheory.BFS;
...
public class BFSTest {
    ...
    public void test1() {
        ...
        BFS.bfs(graph, v[1], new TestVertexVisitor());

        Assert.assertArrayEquals(new int[]{1, 2, 5, 4, 3, 7, 12, 6, 10, 11},
                vertices);
    }
    ...
    public void test2() {
        ...
        BFS.bfs(graph, v[0], new TestVertexVisitor());
    ...
    public void test3() {
        ...
        BFS.bfs(graph, v[8], new TestVertexVisitor());
