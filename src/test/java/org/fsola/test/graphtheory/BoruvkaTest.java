...
import org.fsola.graphtheory.Boruvka;
...
public class BoruvkaTest {
    ...
    public void test1() {
        ...
        EdgeList<Vertex> graph = Graph.buildEdgeListGraphExample13(v);

        Boruvka.Result<Vertex> r = Boruvka.boruvka(v, graph);
