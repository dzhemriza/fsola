...
public class EdgeListTest {
    ...
    public void test1() {
        ...
        EdgeList<Vertex> graph = Graph.buildEdgeListGraphExample1(v);
    ...
    public void test3() {
        ...
        Assert.assertEquals(2, neighbors.get(0).getNum());
        Assert.assertEquals(1, neighbors.get(1).getNum());
    }
