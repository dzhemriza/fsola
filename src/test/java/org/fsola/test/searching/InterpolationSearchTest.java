 ...
 * org.fsola
 *
 * File Name: InterpolationSearchTest.java
 *
...
import org.fsola.searching.InterpolationSearch;
...
public class InterpolationSearchTest {
    ...
    public void test1() {
        ...
        for (int i = 0; i < a.length; ++i) {
            int result = InterpolationSearch.search(a, a[i]);
            Assert.assertEquals(a[i], a[result]);
        }

        for (int i = 2048; i < 4098; ++i) {
            Assert.assertEquals(-1, InterpolationSearch.search(a, i));
        }
    }
}
