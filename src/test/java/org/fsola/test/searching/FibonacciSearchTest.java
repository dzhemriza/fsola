 ...
 * org.fsola
 *
 * File Name: FibonacciSearchTest.java
 *
...
import org.fsola.searching.FibonacciSearch;
...
public class FibonacciSearchTest {
    ...
    public void test1() {
        ...
        for (int i = 0; i < a.length; ++i) {
            int result = FibonacciSearch.fibSearch(a, a[i]);
            Assert.assertEquals(a[i], a[result]);
        }

        for (int i = 2048; i < 4098; ++i) {
            Assert.assertEquals(-1, FibonacciSearch.fibSearch(a, i));
        }
    }
}
