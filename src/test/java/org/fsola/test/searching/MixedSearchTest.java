 ...
 * org.fsola
 *
 * File Name: MixedSearchTest.java
 *
...
import org.fsola.searching.MixedSearch;
...
public class MixedSearchTest {
    ...
    public void test1() {
        ...
        for (int i = 0; i < a.length; ++i) {
            int result = MixedSearch.search(a, a[i], 21);
            Assert.assertEquals(a[i], a[result]);
        }

        for (int i = 2048; i < 4098; ++i) {
            Assert.assertEquals(-1, MixedSearch.search(a, i, 21));
        }
    }
}
